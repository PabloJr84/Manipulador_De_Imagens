...

{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            listBox1.Items.AddRange(files);
            files = Directory.GetFiles(folderBrowserDialog1.SelectedPath, "*.avi");
            listBox1.Items.AddRange(files);
            ...
            files2 = dir_files.GetFiles("*.bmp", SearchOption.TopDirectoryOnly);
            foreach (var fil in files2)
            {
                listBox2.Items.Add(fil.Name);
            }
            ...
            files2 = dir_files.GetFiles("*.avi", SearchOption.TopDirectoryOnly);
            foreach (var fil in files2)
            {
                listBox2.Items.Add(fil.Name);
            }
